...
{
    /// <summary>
    /// Clase base de una excepción lanzada por DBConnector.
    /// </summary>
    /// <remarks>
    ...
    public class DBConnectorException : Exception
    {
        ...
        ///         1.0 08/10/2015 Marcos Abraham Hernández Bravo (Ada Ltda.): versión inicial.
        /// </remarks>
        public DBConnectorException() : base() { }
        ...
        public DBConnectorException(string mensaje)
            : base(mensaje) { }
        ...
        public DBConnectorException(string mensaje, Exception innerException)
